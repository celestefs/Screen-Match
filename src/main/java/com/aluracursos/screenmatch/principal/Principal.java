...
public class Principal {
    ...
    private final String API_KEY = "&apikey=d714637b";
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Escriba el género de series que desee buscar:");
    ...
    private void filtrarPorTemporadasYEvaluacion() {
        ...
        teclado.nextLine();
        System.out.println("Filtrar series por cuál evaluación:");
